  ...
  <div class="normal-page profile-page checkout">
    <div class="container">
      <div class="cart-details">
        <p>
          RETURNING CUSTOMER?
          <a class="font-weight-bold black-link" href="#">CLICK HERE TO LOG IN</a>
        </p>
              ...
              <div class="row">
                ...
                <div class="col-md-9 p-0">
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <p>AED 364</p>
                    <div
                      class="quantity-counter d-flex align-items-center justify-content-center p-1"
                    >
              ...
              <form class="form">
                ...
                <div class="form-group">
                  ...
                  <select id="profile-country" class="form-control">
                    <option name="Egypt" value="1">Egypt</option>
                    <option name="United Arab Emirates" value="2">United Arab Emirates</option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="profile-code">ZIP/POSTAL CODE*</label>
                ...
                <div class="form-group">
                  <label for="another-address">SHIP TO A DIFFERENT ADDRESS?</label>
